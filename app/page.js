...
const ScrollToTop = () => {
  ...
  return (
    <motion.button
      ...
      onClick={scrollToTop}
      className={`fixed bottom-6 right-6 z-50 p-3 rounded-full bg-gradient-to-br from-[#339989] to-[#7DE2D1] text-[#131515] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 ${
