    ...
    <section id="experience" className="w-full min-h-screen px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 bg-[#131515] scroll-mt-16 sm:scroll-mt-20">
      ...
      <div className="max-w-4xl lg:max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          {/* Left Column - Takes full width on mobile, 1/3 on desktop */}
          <div className="lg:col-span-1 space-y-6">
            ...
            <motion.div
              ...
              initial="hidden"
              whileInView="visible"
              className="bg-[#2B2C28] border border-[#339989]/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg"
            >
              <h3 className="text-xl sm:text-2xl font-bold text-[#FFFAFB] font-playfair mb-3 sm:mb-4">Other Experiences</h3>
              <ul className="space-y-2 sm:space-y-3 text-[#FFFAFB]/80 text-xs sm:text-sm">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <motion.div
                ...
                initial="hidden"
                whileInView="visible"
                className="bg-[#2B2C28] border border-[#339989]/20 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-lg"
              >
                <h4 className="text-lg sm:text-xl font-bold text-[#FFFAFB] mb-2 sm:mb-3">Computer Proficiency</h4>
                <p className="text-xs sm:text-sm text-[#FFFAFB]/80 leading-relaxed">{computerProficiency.join(' • ')}</p>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-[#2B2C28] border border-[#339989]/20 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-lg"
              >
                <h4 className="text-lg sm:text-xl font-bold text-[#FFFAFB] mb-2 sm:mb-3">Languages</h4>
                <p className="text-xs sm:text-sm text-[#FFFAFB]/80 leading-relaxed">{languagesSpoken.join(' • ')}</p>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-[#2B2C28] border border-[#339989]/20 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-lg"
              >
                <h4 className="text-lg sm:text-xl font-bold text-[#FFFAFB] mb-2 sm:mb-3">Professional Memberships</h4>
                <ul className="text-xs sm:text-sm text-[#FFFAFB]/80 space-y-1 sm:space-y-2">
                  {professionalMemberships.map((membership, idx) => (
                    <li key={idx} className="leading-relaxed">{membership}</li>
                  ))}
                </ul>
              </motion.div>
            </div>
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              initial="hidden"
              whileInView="visible"
              className="bg-[#2B2C28] border border-[#339989]/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg h-full"
            >
              <h3 className="text-xl sm:text-2xl font-bold text-[#FFFAFB] font-playfair mb-4 sm:mb-6">Technical Skills & Knowledge</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-[#FFFAFB]/80">
                {Object.entries(technicalSkills).map(([category, items]) => (
                  <div key={category} className="space-y-2">
                    <p className="text-[#7DE2D1] font-semibold capitalize text-sm sm:text-base">
